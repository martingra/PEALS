...
namespace PalmHandSegmentation
{
    public class PalmHandSegmentation
    {
         ...
         *  
        */
        public Image<Gray, byte> getCirclePalm(Image<Gray, byte> BinaryHandImage, out CircleF palm)
        {
        ...
        public Image<Gray, byte> getPalm(Image<Gray, byte> BinaryHandImage, out Contour<Point> palm_contour)
        {
            #region variable Initialisation
            Contour<Point> contours;
            Contour<Point> biggestContour = null;
            ...
            if (biggestContour != null)
            {
                ...
                // perform AND operation to BinaryHandImage
                palm_contour = importantDepthPoint;
                result = temp.And(BinaryHandImage);
            }
