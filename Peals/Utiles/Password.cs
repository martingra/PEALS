...
namespace Peals.Utiles
{
    public class Password
    {
        ...
        public static string HashPassword(string password)
        {
            ...
            return ComputeHash(password, new SHA1CryptoServiceProvider()); //SHA256CryptoServiceProvider());
        }
        ...
        {
            return string.Equals(hashPass, ComputeHash(password, new SHA1Managed())); //SHA256Managed()));
        }
