...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-03-2016 a las 23:01:21
...
(9, 'LSA Argentina', '01148546364', 'Gurruchaga ', 568, NULL, NULL, 131, 167, '2016-03-07', 9);
...
ALTER TABLE `peals`.`actividad` 
CHANGE COLUMN `videoExplicacion` `videoExplicacion` VARCHAR(200) NULL DEFAULT NULL ;
